...
<head>
  ...
  <title>Landing Page - WeCan</title>
...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
    ...
    <a href="<?= base_url('web/pilih_login') ?>">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto mr-auto">
          ...
          <li class="nav-item mr-5">
            <a class="nav-link" href="<?php echo base_url('web/pilih_register') ?>">Register</a>
          </li>
            <li class="nav-item mr-5">
            	<a class="nav-link" href="<?php echo base_url('web/pilih_login') ?>"><span class="btn btn-sm btn-success">Login</span></a>
          </li>
        </ul>
      </div>
    <!-- </div> -->
