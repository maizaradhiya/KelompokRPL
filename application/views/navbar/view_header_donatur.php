...
<head>
  ...
  <title>Donatur Page - WeCan</title>
    ...
    <a href="<?= base_url('web/viewhome_donatur') ?>">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto mr-auto">
          ...
          <li class="nav-item mr-auto">
            <a class="nav-link" href="<?php echo base_url('donatur/dataevent') ?>">Cari Event</a>
          </li>
          <li class="nav-item mr-auto">
            <a class="nav-link" href="<?php echo base_url('donatur/riwayat_pendonasian') ?>">Riwayat Donasi</a>
          </li>
          <li class="nav-item mr-auto">
