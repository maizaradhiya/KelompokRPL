...
<head>
  ...
  <title>Penggalang Dana Page - WeCan</title>
...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top" style="background-color: #e3f2fd;">
    ...
    <a href="<?= base_url('web/viewhome_pd') ?>">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto mr-auto">
          <li class="nav-item mr-auto">
            <a class="nav-link" href="<?php echo base_url('web/viewhome_pd') ?>">Home<span class="sr-only">(current)</span></a>
          </li>
          <li class="nav-item mr-auto">
            <a class="nav-link" href="<?php echo base_url('penggalang_dana/dataevent') ?>">Input Event</a>
          </li>
          <li class="nav-item mr-auto">
            <a class="nav-link" href="<?php echo base_url('penggalang_dana/riwayat_event') ?>">Riwayat Event</a>
          </li>
          <li class="nav-item mr-auto">
            <a class="nav-link" href="<?php echo base_url('web/viewabout') ?>">About</a>
          </li>
          <li class="nav-item mr-auto">
          <a Welcome class="nav-link" >Welcome <?php echo $this->session->userdata('username') ?>,</a>
          </li>
            <li class="nav-item mr-auto">
