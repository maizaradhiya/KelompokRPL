                            ...
                            <div class="row">
                              <div class="col-sm-4 mb-3 mb-sm-0">
                                <div class="text-center">
                                  ...
                                  <a  href="<?= base_url('Auth/login_donatur'); ?>" class="fa fa-user-circle-o" style="font-size: 3em; color:white" ></a>
                              ...
                              <div class="col-sm-4">
                                <div class="text-center">
                                  ...
                                  <a  href="<?= base_url('Auth/login_admin'); ?>" class="fa fa-lock" style="font-size: 3em; color:white" ></a>
                                </div> 
                              <hr> 
                              </div>
                              <div class="col-sm-4">
                                <div class="text-center">
                                  ...
                                  <a  href="<?= base_url('Auth/login_pd'); ?>" class="fa fa-user-circle" style="font-size: 3em; color:white" ></a>
                                </div> 
                              <hr> 
                              </div>
                              </div>
